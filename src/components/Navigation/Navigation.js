    ...
    return (
        <header className="text-gray-600 body-font bg-blue-300">
            <div className="mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center font-medium">
                ...
                <a href="https://drive.google.com/file/d/1pDrdH5f2zm8qF1O-W7pWlTsKdsF-J1vM/view?usp=sharing" target="_blank" rel="noreferrer" className="inline-flex items-center bg-pink-600 text-yellow-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 hover:text-pink-600 rounded text-base mt-4 md:mt-0">Resume
